...
public class LegacyItemMigrator implements Command<ServerCommandSource> {
    private static final Map<Item, Item> ITEM = Map.ofEntries(
            Map.entry(DeprecatedItem.STATIC_TRAINER_SPAWN_EGG, MiscItem.MANNEQUIN_SPAWN_EGG),
            Map.entry(DeprecatedItem.NEUTRAL_TRAINER_SPAWN_EGG, MiscItem.TRAINER_SPAWN_EGG)
    );
