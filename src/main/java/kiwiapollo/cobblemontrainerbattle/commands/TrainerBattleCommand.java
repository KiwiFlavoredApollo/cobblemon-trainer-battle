...
import kiwiapollo.cobblemontrainerbattle.battlebuilders.FlatLevelFullHealthTrainerBattleBuilder;
import kiwiapollo.cobblemontrainerbattle.battlebuilders.TrainerBattleBuilder;
        ...
        return RequiredArgumentBuilder.<ServerCommandSource, String>argument("trainer", StringArgumentType.string())
                .executes(context -> {
                    try {
                        ...
                        CobblemonTrainerBattle.LOGGER.error(String.format("Trainer %s does not exist", trainer));
                        return -1;
                    }
                });
    }
