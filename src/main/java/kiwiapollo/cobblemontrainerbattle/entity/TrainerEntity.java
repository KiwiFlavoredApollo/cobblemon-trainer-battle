...
public class TrainerEntity extends BattleEntity implements Angerable {
    ...
    public static class Factory implements EntityType.EntityFactory<TrainerEntity> {
        ...
        public TrainerEntity create(EntityType<TrainerEntity> type, World world) {
            TrainerEntity entity = new TrainerEntity(type, world);
