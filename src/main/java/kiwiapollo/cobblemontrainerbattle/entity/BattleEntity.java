...
public abstract class BattleEntity extends PathAwareEntity implements BattleEntityBehavior {
    ...
    private static final TrackedData<String> TEXTURE = DataTracker.registerData(BattleEntity.class, TrackedDataHandlerRegistry.STRING);

    private static final String TRAINER_NBT_KEY = "Trainer";

    private UUID battleId;

    public BattleEntity(EntityType<? extends PathAwareEntity> type, World world) {
        super(type, world);
    }
    ...
    private static class TrainerTemplateFactory {
        ...
        TrainerTemplateFactory(TrainerTemplate template, BattleEntity entity) {
