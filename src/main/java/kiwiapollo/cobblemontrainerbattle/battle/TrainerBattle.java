...
public class TrainerBattle implements PokemonBattle {
    private final AbstractPokemonBattle battle;
    ...
    private AbstractPokemonBattle createTrainerBattle(ServerPlayerEntity player, TrainerTemplate trainer) {
