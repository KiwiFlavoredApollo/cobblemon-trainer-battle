...
public class CustomGameRule {
    public static GameRules.Key<GameRules.IntRule> MAXIMUM_PER_TRAINER_SPAWN_COUNT;
    public static GameRules.Key<GameRules.IntRule> TRAINER_SPAWN_INTERVAL_IN_SECONDS;

    public static void register() {
        MAXIMUM_PER_TRAINER_SPAWN_COUNT = GameRuleRegistry.register("maximumPerTrainerSpawnCount", GameRules.Category.MISC, GameRuleFactory.createIntRule(1, 0, Integer.MAX_VALUE));
