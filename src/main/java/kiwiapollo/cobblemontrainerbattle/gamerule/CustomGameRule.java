...
public class CustomGameRule {
    ...
    public static GameRules.Key<GameRules.IntRule> TRAINER_FLEE_DISTANCE_IN_BLOCKS;
    ...
    public static void register() {
        ...
        TRAINER_FLEE_DISTANCE_IN_BLOCKS = GameRuleRegistry.register("trainerFleeDistanceInBlocks", GameRules.Category.MISC, GameRuleFactory.createIntRule(32, 16, 128));
