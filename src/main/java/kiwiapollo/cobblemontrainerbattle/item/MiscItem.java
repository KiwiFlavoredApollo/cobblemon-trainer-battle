...
public class MiscItem {
    public static final Item NEUTRAL_TRAINER_SPAWN_EGG = new SpawnEggItem(CustomEntityType.NEUTRAL_TRAINER, 0xAAAAAA, 0xFF5555, new FabricItemSettings().maxCount(64));
