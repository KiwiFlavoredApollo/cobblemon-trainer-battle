...
public class TrainerEntityLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> exporter) {
        exporter.accept(Identifier.of(CobblemonTrainerBattle.MOD_ID, "entities/trainer"), LootTable.builder().pool(LootPool.builder()
                .rolls(ConstantLootNumberProvider.create(1.0f))
                .with(ItemEntry.builder(MiscItems.TRAINER_TOKEN)
